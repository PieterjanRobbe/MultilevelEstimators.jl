...
## rates ##
α(estimator::IndexTypeEstimator) = α.(estimator,1:ndims(estimator))
...
β(estimator::IndexTypeEstimator) = β.(estimator,1:ndims(estimator))
...
γ(estimator::IndexTypeEstimator) = γ.(estimator,1:ndims(estimator))
